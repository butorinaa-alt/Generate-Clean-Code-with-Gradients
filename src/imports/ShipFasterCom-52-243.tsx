import svgPaths from "./svg-1x69ictmwb";
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col h-[495px] items-start justify-between left-1/2 pb-[29px] pt-[25px] px-[16px] top-[5403px] translate-x-[-50%]" data-name="section-footer">
...
function SectionFounder() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[50px] h-[1406px] items-start left-1/2 pb-[60px] pt-[70px] px-[16px] top-[3995px] translate-x-[-50%] w-[375px]" data-name="section-founder">
      <Div4 />
      <Div8 />
    </div>
  );
