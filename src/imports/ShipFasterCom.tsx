import svgPaths from "./svg-jimg9aokpw";
...
function BackgroundShapes() {
  return (
    <div className="absolute h-[773px] left-0 top-0 w-[1440px]" data-name="Background Shapes">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1440 773">
        <g clipPath="url(#clip0_1_304)" id="Background Shapes">
          <g filter="url(#filter0_f_1_304)" id="Ellipse 7">
            <path d={svgPaths.p29166e80} fill="var(--fill-0, #E24E1D)" fillOpacity="0.25" />
          </g>
          <g filter="url(#filter1_f_1_304)" id="Ellipse 8">
            <path d={svgPaths.p3e0b1000} fill="var(--fill-0, #E24E1D)" fillOpacity="0.25" />
          </g>
          <g filter="url(#filter2_f_1_304)" id="Vector">
            <path d={svgPaths.p186a7f80} fill="var(--fill-0, #E24E1D)" fillOpacity="0.15" />
          </g>
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="684" id="filter0_f_1_304" width="892" x="-369" y="-130">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_1_304" stdDeviation="50" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="682.545" id="filter1_f_1_304" width="920.632" x="979.625" y="90.8179">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_1_304" stdDeviation="50" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="684" id="filter2_f_1_304" width="1037" x="293" y="86">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_1_304" stdDeviation="50" />
          </filter>
          <clipPath id="clip0_1_304">
            <rect fill="white" height="773" width="1440" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function Div() {
  return (
    <div className="content-stretch flex flex-col items-center not-italic relative shrink-0 text-center text-white w-[338px]" data-name="div">
      ...
      <p className="font-['Inter:Regular',sans-serif] leading-[22px] relative shrink-0 text-[17px] w-full">Let’s build something meaningful together</p>
    </div>
  );
}
...
function Link() {
  return (
    <div className="h-[15px] relative shrink-0 w-[119px]" data-name="link">
      <div className="absolute flex flex-col font-['Inter:Regular',sans-serif] inset-0 justify-center leading-[0] not-italic text-[17px] text-[rgba(255,255,255,0.8)] text-right">
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[171px] h-[474px] items-start left-1/2 pb-[150px] pt-[55px] px-[80px] top-[3425.95px] translate-x-[-50%] w-[1440px]" data-name="section-footer">
...
function TalkDetails() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start leading-[normal] not-italic relative shrink-0 text-[#c7390a] text-[20px] w-full" data-name="Talk Details">
      <p className="font-['Figma_Hand:Regular',sans-serif] relative shrink-0 w-full">My recent talk:</p>
      <p className="font-['Solitreo:Regular',sans-serif] relative shrink-0 w-full">Context Engineering in LLM Pipelines — PEC London 2025</p>
    </div>
  );
}
...
function Div7() {
  return (
    <div className="content-stretch flex flex-col h-[455px] items-start justify-between relative shrink-0 w-[620px]" data-name="div">
      <div className="font-['Inter:Regular',sans-serif] h-[287px] leading-[22px] max-w-[505px] not-italic relative shrink-0 text-[17px] text-black w-[505px]">
...
function Div8() {
  return (
    <div className="content-stretch flex gap-[40px] items-center relative shrink-0 w-full" data-name="div">
      <div className="h-[565px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[620px]" data-name="Image">
...
function SectionFounder() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[69px] h-[869px] items-start left-1/2 p-[80px] top-[2556.95px] translate-x-[-50%] w-[1440px]" data-name="section-founder">
      <Div4 />
      <Div8 />
    </div>
  );
...
function LinkedInContent() {
  return (
    <div className="content-stretch flex flex-col gap-[31px] items-start not-italic relative shrink-0 w-[580px]" data-name="LinkedIn Content">
      <p className="font-['Inter:Medium',sans-serif] leading-[33px] relative shrink-0 text-[#d03e0d] text-[30px] tracking-[-0.3px] w-full">LinkedIn Content Partnership</p>
      <p className="font-['Inter:Regular',sans-serif] leading-[22px] relative shrink-0 text-[17px] text-black w-full">Reach 10k+ senior tech leaders from big tech. Partner with me to share your AI tools, case studies, or product launches with an audience that ships, not just strategizes.</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[#ff8d67] items-center justify-center relative rounded-[55px] shrink-0 to-[#e24e1d] w-[540px]">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] h-[56px] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-center text-white w-[304px]">
...
function LinkedInAudience() {
  return (
    <div className="content-stretch flex flex-col gap-[33px] items-start pb-0 pt-[10px] px-0 relative shrink-0 w-[540px]" data-name="LinkedIn Audience">
      <p className="font-['Inter:Semi_Bold',sans-serif] leading-[22px] min-w-full not-italic relative shrink-0 text-[20px] text-black w-[min-content]">My audience:</p>
      <ul className="block font-['Inter:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[17px] text-black w-[min-content]">
...
function LinkedInSectionGradientcolor() {
  return (
    <div className="h-[319px] mb-[-104px] relative rounded-[20px] shrink-0 w-full" data-name="LinkedIn Section gradientcolor">
      <div className="size-full">
        <div className="content-start flex flex-wrap gap-[80px] h-[319px] items-start px-[40px] py-[46px] relative w-full">
          <LinkedInContent />
          <LinkedInAudience />
        </div>
      </div>
...
function SectionLinkedin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[500px] items-center left-1/2 pb-[144px] pt-[40px] px-[80px] top-[2056.95px] translate-x-[-50%] w-[1440px]" data-name="section-linkedin">
...
function OfferCardImage() {
  return (
    <div className="h-[91px] mb-[-28px] relative shrink-0 w-full" data-name="Offer Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] top-[18.05px] w-[620px]" data-name="Offer substrate gray" />
      <Div13 />
    </div>
  );
}
...
function Div14() {
  return (
    <div className="content-stretch flex flex-col gap-[17px] items-start not-italic relative shrink-0 text-black w-[369px]" data-name="div">
      <p className="font-['Inter:Semi_Bold',sans-serif] leading-[22px] relative shrink-0 text-[20px] w-full">Streams:</p>
      <ul className="block font-['Inter:Regular',sans-serif] h-[130px] leading-[0] relative shrink-0 text-[17px] w-full">
        <li className="mb-[10px] ms-[25.5px]">
...
function Div15() {
  return (
    <div className="content-stretch flex flex-col gap-[50px] items-start relative shrink-0 w-full" data-name="div">
      <p className="font-['Inter:Medium',sans-serif] leading-[33px] min-w-full not-italic relative shrink-0 text-[#e24e1d] text-[30px] tracking-[-0.3px] w-[min-content]">Consultancy and advising</p>
      <Div14 />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[#ff8d67] items-center justify-center relative rounded-[55px] shrink-0 to-[#e24e1d] w-full">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] h-[56px] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-center text-white w-[147px]">
...
function CardGray() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[514px] items-start justify-between mb-[-28px] px-[40px] py-[50px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[620px]" data-name="card-gray">
      <Div15 />
      <Frame />
    </div>
  );
...
function OfferCard1() {
  return (
    <div className="content-stretch flex flex-col h-[579px] items-start pb-[28px] pt-0 px-0 relative shrink-0 w-[620px]" data-name="Offer Card1">
      <OfferCardImage />
      <CardGray />
    </div>
  );
...
function TestimonialZIndex() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[11px] h-[212px] items-start pb-[30px] pt-[18px] px-[23px] relative rounded-[20px] w-[349px]" data-name="Testimonial Z index 5">
      ...
      <p className="font-['Inter:Regular',sans-serif] leading-[17px] min-w-full not-italic relative shrink-0 text-[#acacac] text-[14px] w-[min-content]">“We ordered the report twice for 10 different markets — exactly what we needed to design our GTM strategy for markets we weren’t familiar with.”</p>
...
function OfferDetails() {
  return (
    <div className="content-stretch flex flex-col gap-[17px] items-start not-italic relative shrink-0 text-white w-[458px]" data-name="Offer Details">
      <p className="font-['Inter:Semi_Bold',sans-serif] leading-[22px] relative shrink-0 text-[20px] w-full">What you get:</p>
      <ul className="block font-['Inter:Regular',sans-serif] h-[175px] leading-[0] relative shrink-0 text-[17px] w-full">
        <li className="mb-[10px] ms-[25.5px]">
...
function OfferCard() {
  return (
    <div className="content-stretch flex flex-col gap-[50px] items-start relative shrink-0 w-full" data-name="Offer Card">
      <p className="font-['Inter:Medium',sans-serif] leading-[33px] min-w-full not-italic relative shrink-0 text-[30px] text-white tracking-[-0.3px] w-[min-content]">Custom LLM Pipelines</p>
      <OfferDetails />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center relative rounded-[55px] shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] h-[56px] justify-center leading-[0] not-italic relative shrink-0 text-[#e24e1d] text-[18px] text-center w-[183px]">
...
function OffersSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11px] items-center left-1/2 pb-0 pt-[40px] px-[160px] top-[1245px] translate-x-[-50%] w-[1440px]" data-name="Offers Section">
...
function Div17() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start not-italic relative shrink-0 w-full" data-name="div">
      ...
      <p className="font-['Inter:Regular',sans-serif] leading-[22px] relative shrink-0 text-[17px] text-black w-full">years building and scaling tech products: from Product Manager at Yandex to CEO of AI Startup (US, $2M funding)</p>
    </div>
  );
}
...
function Card() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start max-w-[290px] relative shrink-0 w-[290px]" data-name="Card">
      <Div17 />
      <Div18 />
    </div>
  );
...
function Card1() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start max-w-[290px] not-italic relative shrink-0 w-[290px]" data-name="Card">
      ...
      <p className="font-['Inter:Regular',sans-serif] leading-[22px] relative shrink-0 text-[17px] text-black w-full">products from 0 to 1: 35M+ MAU, 3-month idea-to-revenue cycle, launched across US/EU/CIS markets</p>
    </div>
  );
}
...
function Div19() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start not-italic relative shrink-0 w-full" data-name="div">
      ...
      <p className="font-['Inter:Regular',sans-serif] leading-[22px] relative shrink-0 text-[17px] text-black w-full">followers on LinkedIn, generating 1.5M+ yearly impressions</p>
    </div>
  );
}
...
function Div20() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-[145px]" data-name="div">
      <div className="flex h-[32.526px] items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "145", "--transform-inner-height": "30" } as React.CSSProperties}>
...
function Card2() {
  return (
    <div className="content-stretch flex flex-col gap-[26px] items-start max-w-[290px] relative shrink-0 w-[290px]" data-name="Card">
      <Div19 />
      <Div20 />
    </div>
  );
...
function Card3() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start max-w-[290px] not-italic relative shrink-0 w-[290px]" data-name="Card">
      ...
      <p className="font-['Inter:Regular',sans-serif] leading-[22px] relative shrink-0 text-[17px] text-black w-full">years of building AI products as a PM, CEO, and advisor across multiple markets</p>
    </div>
  );
}
...
function StatsCards() {
  return (
    <div className="basis-0 content-stretch flex gap-[40px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Stats Cards">
      <Card />
      <Card1 />
      <Card2 />
      <Card3 />
...
function StatsIcon() {
  return (
    <div className="h-[37.235px] mb-[-12px] relative shrink-0 w-[31.264px]" data-name="Stats Icon">
...
function DecorativeLayerMagicPositionAbsolute() {
  return (
    <div className="absolute content-stretch flex flex-col items-end justify-center left-[1127px] pb-[12px] pt-0 px-0 top-[164px] w-[161.264px]" data-name="Decorative layer (magic) → position: absolute">
...
function DecorativeLayerHeartPositionAbsolute() {
  return (
    <div className="absolute h-[76px] left-[809px] top-[144px] w-[44.421px]" data-name="Decorative layer (heart) → position: absolute">
...
function SectionStats() {
  return (
    <div className="absolute content-stretch flex h-[520px] items-start left-1/2 pb-[100px] pt-[174px] px-[80px] top-[725px] translate-x-[-50%] w-[1440px]" data-name="section-stats">
      <StatsCards />
      <DecorativeLayerMagicPositionAbsolute />
      <DecorativeLayerHeartPositionAbsolute />
      <div className="absolute h-px left-[413px] top-[296px] w-[80px]" data-name="Decorative layer (line) → position: absolute">
...
function HeroHeading() {
  return (
    <div className="content-stretch flex flex-col font-['Instrument_Serif:Regular',sans-serif] gap-px items-center leading-[63px] relative shrink-0 text-[70px] tracking-[-0.7px] w-full" data-name="Hero Heading">
      <div className="relative shrink-0 text-[#2c2c2c] w-full">
        <p className="mb-0">{`Yandex Sr. PM → `}</p>
        <p>{`AI Startup CEO ($2M funding) `}</p>
      </div>
      <p className="relative shrink-0 text-[#c7390a] text-right w-full">→ Your shipping partner</p>
    </div>
  );
}
...
function HeroContent() {
  return (
    <div className="content-stretch flex flex-col gap-[69px] items-end not-italic relative shrink-0 w-[960px]" data-name="Hero Content">
      <HeroHeading />
      <p className="font-['Inter:Regular',sans-serif] leading-[24px] relative shrink-0 text-[#2c2c2c] text-[19px] w-[388px]">Building AI products since 2018 as PM, CEO and Advisor – before ChatGPT existed</p>
    </div>
  );
}
...
function HeroSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[201px] h-[659px] items-center left-1/2 overflow-clip px-[183px] py-[76px] top-[66px] translate-x-[-50%] w-[1440px]" data-name="Hero Section">
      <HeroContent />
      <HeroLogos />
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 overflow-clip px-[80px] py-[20px] top-0 translate-x-[-50%] w-[1440px]" data-name="section-header">
      <Header />
    </div>
  );
}
