import svgPaths from "./svg-brc5noyy6i";
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[98px] h-[379px] items-start left-1/2 pb-[155px] pt-[55px] px-[41px] top-[3247px] translate-x-[-50%] w-[1024px]" data-name="section-footer">
...
function SectionFounder() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[69px] h-[816px] items-start left-[calc(50%-0.5px)] pb-[60px] pt-[50px] px-[24px] top-[2431px] translate-x-[-50%] w-[1023px]" data-name="section-founder">
      <Div4 />
      <Div8 />
    </div>
  );
...
function SectionLinkedin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[500px] items-center left-[calc(50%-0.5px)] pb-[144px] pt-[16px] px-[24px] top-[1931px] translate-x-[-50%] w-[1023px]" data-name="section-linkedin">
...
function OfferCardImage() {
  return (
    <div className="h-[91px] mb-[-29px] relative shrink-0 w-full" data-name="Offer Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] top-[17.05px] w-[480px]" data-name="Offer substrate gray" />
      <Div13 />
    </div>
  );
}
...
function CardGray() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[517px] items-start justify-between mb-[-29px] px-[20px] py-[50px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[480px]" data-name="card-gray">
      <Div15 />
      <Frame />
    </div>
  );
...
function OfferCard1() {
  return (
    <div className="content-stretch flex flex-col h-[579px] items-start pb-[29px] pt-0 px-0 relative shrink-0 w-[480px]" data-name="Offer Card1">
      <OfferCardImage />
      <CardGray />
    </div>
  );
...
function TestimonialCardImage() {
  return (
    <div className="h-[252.952px] mb-[-87px] relative shrink-0 w-full" data-name="Testimonial Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.12)] top-[121px] w-[480px]" data-name="Offers substrate ogange Z index 0" />
...
function CardOrange() {
  return (
    <div className="content-stretch flex flex-col h-[517px] items-start justify-between mb-[-87px] px-[20px] py-[50px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[480px]" data-name="card-orange">
      <OfferCard />
      <Frame2 />
    </div>
  );
...
function OfferCard2() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[87px] pt-0 px-0 relative shrink-0 w-[480px]" data-name="Offer Card2">
...
function OffersSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11px] items-center left-1/2 pb-0 pt-[40px] px-[24px] top-[1119px] translate-x-[-50%] w-[1024px]" data-name="Offers Section">
...
function SectionStats() {
  return (
    <div className="absolute content-stretch flex h-[485px] items-start left-1/2 pb-[60px] pt-[152px] px-[24px] top-[634px] translate-x-[-50%] w-[1024px]" data-name="section-stats">
      <StatsCards />
...
function HeroSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[113px] h-[563px] items-center left-1/2 px-[24px] py-[76px] top-[71px] translate-x-[-50%] w-[1024px]" data-name="Hero Section">
      <HeroContent />
      <HeroLogos />
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 overflow-clip px-[24px] py-[20px] top-0 translate-x-[-50%] w-[1024px]" data-name="section-header">
      <Header />
    </div>
  );
}
