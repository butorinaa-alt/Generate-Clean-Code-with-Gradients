import svgPaths from "./svg-owci5el4i1";
...
function Div() {
  return (
    <div className="content-stretch flex flex-col items-center not-italic relative shrink-0 text-center text-white w-[399px]" data-name="div">
...
function Div1() {
  return (
    <div className="content-start flex flex-wrap gap-[51px] items-start justify-between relative shrink-0 w-[399px]" data-name="div">
      <Div />
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[84px] h-[495px] items-start left-1/2 pb-[29px] pt-[25px] px-[16px] top-[5119px] translate-x-[-50%] w-[430px]" data-name="section-footer">
...
function Div6() {
  return (
    <div className="content-stretch flex flex-col gap-[15px] h-[353px] items-start justify-center relative shrink-0 w-full" data-name="div">
      <Div5 />
...
function Div7() {
  return (
    <div className="content-stretch flex flex-col gap-[17px] h-[455px] items-start relative shrink-0 w-[398px]" data-name="div">
      <div className="font-['Inter:Regular',sans-serif] font-normal h-[362px] leading-[22px] max-w-[505px] not-italic relative shrink-0 text-[17px] text-black w-full">
...
function Div8() {
  return (
    <div className="content-center flex flex-wrap gap-[30px] h-[866px] items-center relative shrink-0 w-full" data-name="div">
      <div className="h-[381px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[398px]" data-name="Image">
...
function SectionFounder() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[50px] h-[1457px] items-start left-1/2 pb-[85px] pt-[60px] px-[16px] top-[3662px] translate-x-[-50%] w-[430px]" data-name="section-founder">
      <Div4 />
      <Div8 />
    </div>
  );
...
function LinkedInContent() {
  return (
    <div className="content-stretch flex flex-col gap-[31px] items-start not-italic relative shrink-0 w-[358px]" data-name="LinkedIn Content">
...
function LinkedInAudience() {
  return (
    <div className="content-stretch flex flex-col gap-[33px] items-start pb-0 pt-[10px] px-0 relative shrink-0 w-[358px]" data-name="LinkedIn Audience">
...
function LinkedInSectionGradientcolor() {
  return (
    <div className="content-start flex flex-wrap gap-[58px] h-[636px] items-start mb-[-104px] px-[20px] py-[35px] relative rounded-[20px] shrink-0 w-[398px]" data-name="LinkedIn Section gradientcolor">
      <LinkedInContent />
      <LinkedInAudience />
    </div>
  );
...
function LinkedInImage() {
  return (
    <div className="absolute content-stretch flex flex-col items-end left-[18px] top-[602px] w-[277px]" data-name="LinkedIn Image">
...
function SectionLinkedin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[810px] items-center left-1/2 pb-[144px] pt-[50px] px-[24px] top-[2852px] translate-x-[-50%] w-[430px]" data-name="section-linkedin">
...
function OfferCardImage() {
  return (
    <div className="h-[91px] mb-[-28px] relative shrink-0 w-full" data-name="Offer Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] top-[18px] w-[396px]" data-name="Offer substrate gray" />
      <Div13 />
    </div>
  );
}
...
function OffersSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-center left-1/2 pb-0 pt-[20px] px-[24px] top-[1411px] translate-x-[-50%] w-[430px]" data-name="Offers Section">
...
function Div18() {
  return (
    <div className="content-stretch flex flex-col font-['Solitreo:Regular',sans-serif] gap-[3px] items-end leading-[normal] not-italic relative shrink-0 text-[#c7390a] text-[20px] text-right w-[189px]" data-name="div">
...
function Card() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[343px] relative shrink-0 w-[191px]" data-name="Card">
      <Div17 />
      <Div18 />
    </div>
  );
...
function Card1() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start max-w-[343px] not-italic relative shrink-0 w-[191px]" data-name="Card">
...
function DecorativeLayerHeartPositionAbsolute() {
  return (
    <div className="absolute h-[76px] left-[61px] top-[-31px] w-[44.421px]" data-name="Decorative layer (heart) → position: absolute">
...
function Card2() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start max-w-[343px] relative shrink-0 w-[191px]" data-name="Card">
      <Div19 />
      <Div20 />
...
function DecorativeLayerMagicPositionAbsolute() {
  return (
    <div className="absolute content-stretch flex flex-col items-end justify-center left-[240px] pb-[11px] pt-0 px-0 top-[407px] w-[161.264px]" data-name="Decorative layer (magic) → position: absolute">
...
function SectionStats() {
  return (
    <div className="absolute content-stretch flex h-[738px] items-start left-1/2 pb-[90px] pt-[66px] px-[16px] top-[673px] translate-x-[-50%] w-[430px]" data-name="section-stats">
      <StatsCards />
      <DecorativeLayerMagicPositionAbsolute />
      <div className="absolute h-px left-[328px] top-[188px] w-[80px]" data-name="Decorative layer (line) → position: absolute">
...
function HeroSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[78px] h-[615px] items-center left-1/2 pb-[63px] pt-[45px] px-[16px] top-[58px] translate-x-[-50%] w-[430px]" data-name="Hero Section">
      <HeroContent />
      <HeroLogos />
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 overflow-clip px-[16px] py-[20px] top-0 translate-x-[-50%] w-[430px]" data-name="section-header">
      <Header />
    </div>
  );
}
