import svgPaths from "./svg-bnkusr49hg";
...
function BackgroundShapes() {
  return (
    <div className="absolute h-[687px] left-0 top-0 w-[1280px]" data-name="Background Shapes">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1280 687">
        <g clipPath="url(#clip0_16_784)" id="Background Shapes">
          <g filter="url(#filter0_f_16_784)" id="Ellipse 7">
            <path d={svgPaths.p8c9dc70} fill="var(--fill-0, #E24E1D)" fillOpacity="0.25" />
          </g>
          <g filter="url(#filter1_f_16_784)" id="Ellipse 8">
            <path d={svgPaths.pcf75d00} fill="var(--fill-0, #E24E1D)" fillOpacity="0.25" />
          </g>
          <g filter="url(#filter2_f_16_784)" id="Vector">
            <path d={svgPaths.p3678fe00} fill="var(--fill-0, #E24E1D)" fillOpacity="0.15" />
          </g>
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="583" id="filter0_f_16_784" width="748" x="-369" y="-130">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_16_784" stdDeviation="50" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="582.065" id="filter1_f_16_784" width="770.575" x="698.802" y="44.8371">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_16_784" stdDeviation="50" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="583" id="filter2_f_16_784" width="863" x="155" y="41">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_16_784" stdDeviation="50" />
          </filter>
          <clipPath id="clip0_16_784">
            <rect fill="white" height="687" width="1280" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[171px] h-[474px] items-start left-1/2 pb-[150px] pt-[55px] px-[80px] top-[3430.95px] translate-x-[-50%] w-[1280px]" data-name="section-footer">
...
function SectionFounder() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[69px] h-[869px] items-start left-1/2 p-[80px] top-[2561.95px] translate-x-[-50%] w-[1278px]" data-name="section-founder">
      <Div4 />
      <Div8 />
    </div>
  );
...
function SectionLinkedin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[500px] items-center left-1/2 pb-[144px] pt-[40px] px-[80px] top-[2061.95px] translate-x-[-50%] w-[1278px]" data-name="section-linkedin">
...
function OfferCardImage() {
  return (
    <div className="h-[91px] mb-[-29px] relative shrink-0 w-full" data-name="Offer Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] top-[17px] w-[540px]" data-name="Offer substrate gray" />
      <Div13 />
    </div>
  );
}
...
function CardGray() {
  return (
    <div className="bg-white h-[517px] mb-[-29px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-full" data-name="card-gray">
      <div className="size-full">
        <div className="content-stretch flex flex-col h-[517px] items-start justify-between px-[40px] py-[50px] relative w-full">
          <Div15 />
          <Frame />
        </div>
      </div>
...
function OfferCard1() {
  return (
    <div className="content-stretch flex flex-col h-[579px] items-start pb-[29px] pt-0 px-0 relative shrink-0 w-[540px]" data-name="Offer Card1">
      <OfferCardImage />
      <CardGray />
    </div>
  );
...
function TestimonialCardImage() {
  return (
    <div className="h-[252.952px] mb-[-87px] relative shrink-0 w-full" data-name="Testimonial Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.12)] top-[120.95px] w-[540px]" data-name="Offers substrate ogange Z index 0" />
      <div className="absolute flex h-[252.952px] items-center justify-center left-[100px] top-0 w-[372.235px]" style={{ "--transform-inner-width": "349", "--transform-inner-height": "212" } as React.CSSProperties}>
...
function OfferCard() {
  return (
    <div className="content-stretch flex flex-col gap-[50px] items-start relative shrink-0 w-[456px]" data-name="Offer Card">
...
function Frame2() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center relative rounded-[55px] shrink-0 w-[460px]">
...
function CardOrange() {
  return (
    <div className="h-[517px] mb-[-87px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-full" data-name="card-orange">
      <div className="size-full">
        <div className="content-stretch flex flex-col h-[517px] items-start justify-between px-[40px] py-[50px] relative w-full">
          <OfferCard />
          <Frame2 />
...
function OfferCard2() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[87px] pt-0 px-0 relative shrink-0 w-[540px]" data-name="Offer Card2">
...
function Div16() {
  return (
    <div className="content-end flex flex-wrap gap-[40px] items-end relative shrink-0" data-name="div">
      <OfferCard1 />
      <OfferCard2 />
    </div>
  );
...
function OffersSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11px] items-center left-1/2 pb-0 pt-[40px] px-[80px] top-[1250px] translate-x-[-50%] w-[1280px]" data-name="Offers Section">
      <p className="font-['Instrument_Serif:Regular',sans-serif] h-[78px] leading-[70px] not-italic relative shrink-0 text-[70px] text-black text-center w-[1120px]">Work with me</p>
      <Div16 />
    </div>
  );
}
...
function Card() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start max-w-[290px] relative shrink-0 w-[250px]" data-name="Card">
      <Div17 />
      <Div18 />
    </div>
  );
...
function Card1() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start max-w-[290px] not-italic relative shrink-0 w-[250px]" data-name="Card">
...
function Div20() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-[192.898px]" data-name="div">
      <div className="flex h-[33.362px] items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "192.890625", "--transform-inner-height": "30" } as React.CSSProperties}>
...
function Card2() {
  return (
    <div className="content-stretch flex flex-col gap-[26px] items-start max-w-[290px] relative shrink-0 w-[250px]" data-name="Card">
      <Div19 />
      <Div20 />
    </div>
  );
...
function StatsIcon() {
  return (
    <div className="h-[37.235px] relative shrink-0 w-[31.264px]" data-name="Stats Icon">
...
function DecorativeLayerMagicPositionAbsolute() {
  return (
    <div className="absolute content-stretch flex flex-col items-end justify-center left-[1007px] top-[157px] w-[161.264px]" data-name="Decorative layer (magic) → position: absolute">
...
function DecorativeLayerHeartPositionAbsolute() {
  return (
    <div className="absolute h-[76px] left-[721px] top-[144px] w-[44.421px]" data-name="Decorative layer (heart) → position: absolute">
...
function SectionStats() {
  return (
    <div className="absolute content-stretch flex h-[520px] items-start left-1/2 pb-[100px] pt-[174px] px-[80px] top-[730px] translate-x-[-50%] w-[1280px]" data-name="section-stats">
      <StatsCards />
      <DecorativeLayerMagicPositionAbsolute />
      <DecorativeLayerHeartPositionAbsolute />
      <div className="absolute h-px left-[417px] top-[296px] w-[80px]" data-name="Decorative layer (line) → position: absolute">
...
function HeroSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[201px] h-[659px] items-center left-[calc(50%-0.5px)] px-[183px] py-[76px] top-[71px] translate-x-[-50%] w-[1275px]" data-name="Hero Section">
      <HeroContent />
      <HeroLogos />
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 overflow-clip px-[80px] py-[20px] top-0 translate-x-[-50%] w-[1280px]" data-name="section-header">
      <Header />
    </div>
  );
}
