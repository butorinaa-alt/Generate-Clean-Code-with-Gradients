import svgPaths from "./svg-rklnqk97b4";
...
function Link() {
  return (
    <div className="h-[39px] relative shrink-0 w-[109px]" data-name="link">
...
function Link2() {
  return (
    <div className="h-[15px] relative shrink-0 w-[200px]" data-name="link">
...
function Button() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[#ff8d67] items-center justify-center relative rounded-[55px] shrink-0 to-[#e24e1d] w-[540px]" data-name="button">
...
function Link4() {
  return (
    <div className="h-[26px] relative shrink-0 w-[75px]" data-name="link">
...
function Link5() {
  return (
    <div className="h-[26px] relative shrink-0 w-[68px]" data-name="link">
      <div className="absolute flex flex-col font-['Instrument_Serif:Regular',sans-serif] inset-0 justify-center leading-[0] not-italic text-[#2c2c2c] text-[20px] text-nowrap uppercase">
