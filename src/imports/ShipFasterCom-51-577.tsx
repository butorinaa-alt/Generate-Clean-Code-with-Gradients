import svgPaths from "./svg-tnbk1ggv1t";
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[138px] h-[495px] items-start left-1/2 pb-[29px] pt-[25px] px-[16px] top-[5403px] translate-x-[-50%]" data-name="section-footer">
