import svgPaths from "./svg-nzk3ejzl6f";
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-center left-[calc(50%-110.5px)] top-[calc(50%+54.5px)] translate-x-[-50%] translate-y-[-50%] w-[75px]">
      <HeaderText />
      <HeaderText1 />
    </div>
  );
