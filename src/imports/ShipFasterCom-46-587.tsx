import svgPaths from "./svg-0jrvyctssv";
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[138px] h-[495px] items-start left-1/2 pb-[29px] pt-[25px] px-[16px] top-[5403px] translate-x-[-50%] w-[375px]" data-name="section-footer">
...
function SectionFounder() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[50px] h-[1406px] items-start left-1/2 pb-[60px] pt-[70px] px-[16px] top-[3997px] translate-x-[-50%] w-[375px]" data-name="section-founder">
      <Div4 />
      <Div8 />
    </div>
  );
...
function SectionLinkedin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[836px] items-center left-1/2 pb-[144px] pt-[36px] px-[24px] top-[3159px] translate-x-[-50%] w-[375px]" data-name="section-linkedin">
...
function OfferCardImage() {
  return (
    <div className="h-[91px] mb-[-28px] relative shrink-0 w-full" data-name="Offer Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] top-[18px] w-[343px]" data-name="Offer substrate gray" />
      <Div13 />
    </div>
  );
}
...
function CardOrange() {
  return (
    <div className="content-stretch flex flex-col gap-[50px] h-[614px] items-start mb-[-87px] px-[20px] py-[50px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[343px]" data-name="card-orange">
      <OfferCard />
      <Frame2 />
    </div>
  );
...
function Div16() {
  return (
    <div className="content-end flex flex-wrap gap-[16px] items-end relative shrink-0 w-[343px]" data-name="div">
      <OfferCard1 />
      <OfferCard2 />
    </div>
  );
...
function OffersSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-center left-1/2 pb-0 pt-[20px] px-[24px] top-[1705px] translate-x-[-50%] w-[375px]" data-name="Offers Section">
...
function Card() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-start max-w-[343px] relative shrink-0 w-[343px]" data-name="Card">
      <Div17 />
      <Div18 />
    </div>
  );
...
function DecorativeLayerMagicPositionAbsolute() {
  return (
    <div className="absolute content-stretch flex flex-col items-end justify-center left-[179px] pb-[11px] pt-0 px-0 top-[809px] w-[161.264px]" data-name="Decorative layer (magic) → position: absolute">
...
function SectionStats() {
  return (
    <div className="absolute content-stretch flex h-[1038px] items-start left-1/2 pb-[90px] pt-[66px] px-[16px] top-[667px] translate-x-[-50%] w-[375px]" data-name="section-stats">
      <StatsCards />
      <DecorativeLayerMagicPositionAbsolute />
      <div className="absolute h-px left-[278px] top-[458px] w-[80px]" data-name="Decorative layer (line) → position: absolute">
...
function HeroSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[78px] h-[615px] items-center left-1/2 pb-[63px] pt-[45px] px-[16px] top-[52px] translate-x-[-50%] w-[375px]" data-name="Hero Section">
      <HeroContent />
      <HeroLogos />
    </div>
  );
