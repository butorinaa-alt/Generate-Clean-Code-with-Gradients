import svgPaths from "./svg-l52tvttbsq";
...
function DecorativeLayerMagicPositionAbsolute() {
  return (
    <div className="absolute content-stretch flex flex-col items-end justify-center left-[188px] pb-[11px] pt-0 px-0 top-[810px] w-[161.264px]" data-name="Decorative layer (magic) → position: absolute">
