import svgPaths from "./svg-liggwabujg";
...
function Div6() {
  return (
    <div className="content-stretch flex flex-col gap-[15px] h-[353px] items-start justify-center max-w-[398px] relative shrink-0 w-full" data-name="div">
      <Div5 />
...
function LinkedInSectionGradientcolor() {
  return (
    <div className="content-start flex flex-wrap gap-[58px] h-[636px] items-start max-w-[398px] mb-[-104px] px-[20px] py-[35px] relative rounded-[20px] shrink-0 w-[398px]" data-name="LinkedIn Section gradientcolor">
      <LinkedInContent />
      <LinkedInAudience />
    </div>
  );
...
function SectionLinkedin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[810px] items-center left-1/2 pb-[144px] pt-[50px] px-[20px] top-[2852px] translate-x-[-50%] w-[430px]" data-name="section-linkedin">
