import svgPaths from "./svg-lwk81k8abp";
...
function BackgroundShapes() {
  return (
    <div className="absolute h-[567px] left-0 top-0 w-[1024px]" data-name="Background Shapes">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1024 567">
        <g clipPath="url(#clip0_26_258)" id="Background Shapes">
          <g filter="url(#filter0_f_26_258)" id="Ellipse 7">
            <path d={svgPaths.p1f30be00} fill="var(--fill-0, #E24E1D)" fillOpacity="0.25" />
          </g>
          <g filter="url(#filter1_f_26_258)" id="Ellipse 8">
            <path d={svgPaths.p1cc0ff80} fill="var(--fill-0, #E24E1D)" fillOpacity="0.25" />
          </g>
          <g filter="url(#filter2_f_26_258)" id="Vector">
            <path d={svgPaths.p485dc80} fill="var(--fill-0, #E24E1D)" fillOpacity="0.15" />
          </g>
        </g>
        <defs>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="550.753" id="filter0_f_26_258" width="706.626" x="-348.59" y="-122.809">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_26_258" stdDeviation="47.2344" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="549.869" id="filter1_f_26_258" width="727.952" x="660.149" y="42.3569">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_26_258" stdDeviation="47.2344" />
          </filter>
          <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="550.753" id="filter2_f_26_258" width="815.265" x="146.427" y="38.7322">
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_26_258" stdDeviation="47.2344" />
          </filter>
          <clipPath id="clip0_26_258">
            <rect fill="white" height="567" width="1024" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[98px] h-[379px] items-start left-1/2 pb-[155px] pt-[55px] px-[41px] top-[3277px] translate-x-[-50%] w-[1024px]" data-name="section-footer">
...
function Div6() {
  return (
    <div className="content-stretch flex gap-[23px] items-center relative shrink-0 w-[538px]" data-name="div">
      <Div5 />
      <div className="h-[100px] pointer-events-none relative rounded-[20px] shrink-0 w-[168px]" data-name="link https://www.youtube.com/watch?v=_5QOX2Vsk8Y&list=PLQEYbmzcCfpdgo4z4htF2elNKqzwEbDIM&index=16">
...
function Div7() {
  return (
    <div className="content-stretch flex flex-col gap-[25px] h-[455px] items-start relative shrink-0 w-[544px]" data-name="div">
...
function Div8() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="div">
      <div className="h-[565px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[382px]" data-name="Image">
...
function SectionFounder() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[69px] h-[846px] items-start left-1/2 pb-[60px] pt-[80px] px-[24px] top-[2431px] translate-x-[-50%] w-[990px]" data-name="section-founder">
      <Div4 />
      <Div8 />
    </div>
  );
...
function LinkedInContent() {
  return (
    <div className="content-stretch flex flex-col gap-[31px] items-start not-italic relative shrink-0 w-[421px]" data-name="LinkedIn Content">
...
function Frame1() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[#ff8d67] items-center justify-center relative rounded-[55px] shrink-0 to-[#e24e1d] w-[423px]">
...
function LinkedInAudience() {
  return (
    <div className="content-stretch flex flex-col gap-[33px] items-start pb-0 pt-[10px] px-0 relative shrink-0 w-[423px]" data-name="LinkedIn Audience">
...
function LinkedInSectionGradientcolor() {
  return (
    <div className="h-[298px] mb-[-104px] relative rounded-[20px] shrink-0 w-full" data-name="LinkedIn Section gradientcolor">
      <div className="size-full">
        <div className="content-start flex flex-wrap gap-[58px] h-[298px] items-start px-[20px] py-[35px] relative w-full">
          <LinkedInContent />
          <LinkedInAudience />
        </div>
      </div>
...
function LinkedInImage() {
  return (
    <div className="absolute content-stretch flex flex-col items-end left-[31px] top-[255px] w-[351px]" data-name="LinkedIn Image">
...
function SectionLinkedin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[500px] items-center left-1/2 pb-[144px] pt-[16px] px-[24px] top-[1930.95px] translate-x-[-50%] w-[990px]" data-name="section-linkedin">
...
function Div9() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[72.678px] items-start mr-[-5.848px] px-[11.695px] py-[16.708px] relative rounded-[6.683px] shadow-[0px_1.671px_3.342px_0px_rgba(0,0,0,0.25)] shrink-0 w-[108.599px]" data-name="div">
...
function Div10() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[76.019px] items-start mr-[-5.848px] pb-[29.238px] pt-[7.518px] px-[6.683px] relative rounded-[6.683px] shadow-[0px_1.671px_3.342px_0px_rgba(0,0,0,0.25)] shrink-0 w-[105.258px]" data-name="div">
...
function Div11() {
  return (
    <div className="bg-white content-stretch flex h-[72.678px] items-start mr-[-5.848px] pb-[19.214px] pt-[6.683px] px-[8.354px] relative rounded-[6.683px] shadow-[0px_1.671px_3.342px_0px_rgba(0,0,0,0.25)] shrink-0 w-[59.312px]" data-name="div">
      <div className="relative shrink-0 size-[41.769px]" data-name="Offer Image">
...
function Div12() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[76.019px] items-start mr-[-5.848px] pb-[30.074px] pt-[15.037px] px-[8.354px] relative rounded-[6.683px] shadow-[0px_1.671px_3.342px_0px_rgba(0,0,0,0.25)] shrink-0 w-[152.874px]" data-name="div">
...
function Div13() {
  return (
    <div className="absolute content-stretch flex items-end left-[25.5px] pl-0 pr-[5.848px] py-0 top-0" data-name="div">
      <Div9 />
      <Div10 />
      <Div11 />
      <Div12 />
...
function OfferCardImage() {
  return (
    <div className="h-[91px] mb-[-29px] relative shrink-0 w-full" data-name="Offer Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] top-[17.05px] w-[463px]" data-name="Offer substrate gray" />
      <Div13 />
    </div>
  );
}
...
function Div15() {
  return (
    <div className="content-stretch flex flex-col gap-[50px] items-start relative shrink-0 w-[406px]" data-name="div">
...
function CardGray() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[517px] items-start justify-between mb-[-29px] px-[20px] py-[50px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[463px]" data-name="card-gray">
      <Div15 />
      <Frame />
    </div>
  );
...
function OfferCard1() {
  return (
    <div className="content-stretch flex flex-col h-[579px] items-start pb-[29px] pt-0 px-0 relative shrink-0 w-[463px]" data-name="Offer Card1">
      <OfferCardImage />
      <CardGray />
    </div>
  );
...
function TestimonialCardImage() {
  return (
    <div className="h-[252.952px] mb-[-87px] relative shrink-0 w-full" data-name="Testimonial Card Image">
      <div className="absolute h-[66px] left-[-0.5px] rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.12)] top-[121px] w-[463px]" data-name="Offers substrate ogange Z index 0" />
      <div className="absolute flex h-[252.952px] items-center justify-center left-[61px] top-0 w-[372.235px]" style={{ "--transform-inner-width": "349", "--transform-inner-height": "212" } as React.CSSProperties}>
...
function OfferDetails() {
  return (
    <div className="content-stretch flex flex-col gap-[17px] items-start not-italic relative shrink-0 text-white w-[396px]" data-name="Offer Details">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22px] relative shrink-0 text-[20px] w-full">What you get:</p>
      <ul className="block font-['Inter:Regular',sans-serif] font-normal h-[198px] leading-[0] relative shrink-0 text-[17px] w-full">
        <li className="mb-[10px] ms-[25.5px]">
...
function OfferCard() {
  return (
    <div className="content-stretch flex flex-col gap-[50px] h-[335px] items-start relative shrink-0 w-full" data-name="Offer Card">
...
function CardOrange() {
  return (
    <div className="content-stretch flex flex-col h-[517px] items-start justify-between mb-[-87px] px-[20px] py-[50px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[463px]" data-name="card-orange">
      <OfferCard />
      <Frame2 />
    </div>
  );
...
function OfferCard2() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[87px] pt-0 px-0 relative shrink-0 w-[463px]" data-name="Offer Card2">
...
function Div16() {
  return (
    <div className="content-end flex flex-wrap gap-[16px] items-end relative shrink-0" data-name="div">
      <OfferCard1 />
      <OfferCard2 />
    </div>
  );
...
function OffersSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11px] items-center left-1/2 pb-0 pt-[40px] px-[24px] top-[1119px] translate-x-[-50%] w-[990px]" data-name="Offers Section">
      <p className="font-['Instrument_Serif:Regular',sans-serif] h-[78px] leading-[70px] not-italic relative shrink-0 text-[70px] text-black text-center w-[940px]">Work with me</p>
      <Div16 />
    </div>
  );
}
...
function Card() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-start max-w-[290px] relative shrink-0 w-[222px]" data-name="Card">
      <Div17 />
      <Div18 />
    </div>
  );
...
function Card1() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start max-w-[290px] not-italic relative shrink-0 w-[224px]" data-name="Card">
...
function Card2() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start max-w-[290px] relative shrink-0 w-[223px]" data-name="Card">
      <Div19 />
      <Div20 />
    </div>
  );
...
function StatsCards() {
  return (
    <div className="basis-0 content-stretch flex gap-[16px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Stats Cards">
      <Card />
      <Card1 />
      <Card2 />
      <Card3 />
...
function DecorativeLayerMagicPositionAbsolute() {
  return (
    <div className="absolute content-stretch flex flex-col items-end justify-center left-[788px] pb-[11px] pt-0 px-0 top-[145px] w-[161.264px]" data-name="Decorative layer (magic) → position: absolute">
...
function DecorativeLayerHeartPositionAbsolute() {
  return (
    <div className="absolute h-[76px] left-[570px] top-[123px] w-[44.421px]" data-name="Decorative layer (heart) → position: absolute">
...
function SectionStats() {
  return (
    <div className="absolute content-stretch flex h-[485px] items-start left-[calc(50%+0.5px)] pb-[60px] pt-[152px] px-[24px] top-[634px] translate-x-[-50%] w-[989px]" data-name="section-stats">
      <StatsCards />
      <DecorativeLayerMagicPositionAbsolute />
      <DecorativeLayerHeartPositionAbsolute />
      <div className="absolute h-px left-[306px] top-[274px] w-[80px]" data-name="Decorative layer (line) → position: absolute">
...
function HeroHeading() {
  return (
    <div className="content-stretch flex flex-col font-['Instrument_Serif:Regular','Noto_Sans:Regular',sans-serif] gap-px items-center leading-[63px] relative shrink-0 text-[70px] tracking-[-0.7px] w-full" data-name="Hero Heading">
      <div className="relative shrink-0 text-[#2c2c2c] w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 400" }}>
        <p className="mb-0">{`Yandex Sr. PM → `}</p>
        <p>{`AI Startup CEO ($2M funding) `}</p>
      </div>
      <p className="relative shrink-0 text-[#c7390a] text-right w-full" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 400" }}>
...
function HeroSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[113px] h-[563px] items-center left-1/2 px-[24px] py-[76px] top-[71px] translate-x-[-50%] w-[990px]" data-name="Hero Section">
      <HeroContent />
      <HeroLogos />
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 overflow-clip px-[24px] py-[20px] top-0 translate-x-[-50%] w-[990px]" data-name="section-header">
      <Header />
    </div>
  );
}
