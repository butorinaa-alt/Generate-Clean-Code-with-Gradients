import svgPaths from "./svg-pqohruhean";
...
function SectionFooter() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[98px] h-[379px] items-start left-1/2 pb-[155px] pt-[55px] px-[24px] top-[3247px] translate-x-[-50%] w-[1016px]" data-name="section-footer">
...
function Div6() {
  return (
    <div className="content-stretch flex gap-[23px] items-center relative shrink-0 w-[538px]" data-name="div">
      <Div5 />
      <div className="h-[113.017px] pointer-events-none relative rounded-[20px] shrink-0 w-[190px]" data-name="link https://www.youtube.com/watch?v=_5QOX2Vsk8Y&list=PLQEYbmzcCfpdgo4z4htF2elNKqzwEbDIM&index=16">
...
function Div7() {
  return (
    <div className="content-stretch flex flex-col gap-[25px] h-[455px] items-start relative shrink-0 w-[576px]" data-name="div">
...
function Div8() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="div">
      <div className="h-[565px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[398px]" data-name="Image">
...
function SectionFounder() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[69px] h-[816px] items-start left-1/2 pb-[60px] pt-[50px] px-[24px] top-[2431px] translate-x-[-50%] w-[1016px]" data-name="section-founder">
      <Div4 />
      <Div8 />
    </div>
  );
...
function LinkedInContent() {
  return (
    <div className="content-stretch flex flex-col gap-[31px] items-start not-italic relative shrink-0 w-[432px]" data-name="LinkedIn Content">
...
function LinkedInAudience() {
  return (
    <div className="content-stretch flex flex-col gap-[33px] items-start pb-0 pt-[10px] px-0 relative shrink-0 w-[416px]" data-name="LinkedIn Audience">
  ...
  return (
    <div className="h-[298px] mb-[-104px] relative rounded-[20px] shrink-0 w-full" data-name="LinkedIn Section gradientcolor">
      <div className="size-full">
        <div className="content-start flex flex-wrap gap-[60px] h-[298px] items-start px-[30px] py-[35px] relative w-full">
          <LinkedInContent />
          <LinkedInAudience />
        </div>
      </div>
...
function SectionLinkedin() {
  return (
    <div className="absolute content-stretch flex flex-col h-[500px] items-center left-1/2 pb-[144px] pt-[16px] px-[24px] top-[1931px] translate-x-[-50%] w-[1016px]" data-name="section-linkedin">
...
function OfferCardImage() {
  return (
    <div className="h-[91px] mb-[-29px] relative shrink-0 w-[476px]" data-name="Offer Card Image">
      <div className="absolute h-[66px] left-[0.5px] rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] top-[17.05px] w-[475px]" data-name="Offer substrate gray" />
      <Div13 />
    </div>
  );
}
...
function CardGray() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[517px] items-start justify-between mb-[-29px] px-[30px] py-[50px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[476px]" data-name="card-gray">
      <Div15 />
      <Frame />
    </div>
  );
...
function OfferCard1() {
  return (
    <div className="content-stretch flex flex-col h-[579px] items-start pb-[29px] pt-0 px-0 relative shrink-0 w-[476px]" data-name="Offer Card1">
      <OfferCardImage />
      <CardGray />
    </div>
  );
...
function TestimonialCardImage() {
  return (
    <div className="h-[253px] mb-[-87px] relative shrink-0 w-[476px]" data-name="Testimonial Card Image">
      <div className="absolute h-[66px] left-0 rounded-tl-[20px] rounded-tr-[20px] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.12)] top-[121px] w-[476px]" data-name="Offers substrate ogange Z index 0" />
...
function CardOrange() {
  return (
    <div className="content-stretch flex flex-col h-[517px] items-start justify-between mb-[-87px] px-[30px] py-[50px] relative rounded-[20px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.12)] shrink-0 w-[476px]" data-name="card-orange">
      <OfferCard />
      <Frame2 />
    </div>
  );
...
function OfferCard2() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[87px] pt-0 px-0 relative shrink-0" data-name="Offer Card2">
...
function Div16() {
  return (
    <div className="content-end flex flex-wrap gap-[16px] items-end relative shrink-0 w-full" data-name="div">
      <OfferCard1 />
      <OfferCard2 />
    </div>
  );
...
function OffersSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11px] items-center left-1/2 pb-0 pt-[40px] px-[24px] top-[1119px] translate-x-[-50%] w-[1016px]" data-name="Offers Section">
      <p className="font-['Instrument_Serif:Regular',sans-serif] h-[78px] leading-[70px] not-italic relative shrink-0 text-[70px] text-black text-center w-full">Work with me</p>
      <Div16 />
    </div>
  );
}
...
function Card() {
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-start max-w-[290px] relative shrink-0 w-[232px]" data-name="Card">
      <Div17 />
      <Div18 />
    </div>
  );
...
function Card1() {
  return (
    <div className="content-stretch flex flex-col gap-[9px] items-start max-w-[290px] not-italic relative shrink-0 w-[232px]" data-name="Card">
...
function Card2() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start max-w-[290px] relative shrink-0 w-[232px]" data-name="Card">
      <Div19 />
      <Div20 />
    </div>
  );
...
function DecorativeLayerMagicPositionAbsolute() {
  return (
    <div className="absolute content-stretch flex flex-col items-end justify-center left-[831px] pb-[11px] pt-0 px-0 top-[152px] w-[161.264px]" data-name="Decorative layer (magic) → position: absolute">
...
function SectionStats() {
  return (
    <div className="absolute content-stretch flex h-[485px] items-start left-1/2 pb-[60px] pt-[152px] px-[24px] top-[634px] translate-x-[-50%] w-[1016px]" data-name="section-stats">
      <StatsCards />
...
function HeroSection() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[113px] h-[563px] items-center left-1/2 px-[24px] py-[76px] top-[71px] translate-x-[-50%] w-[1016px]" data-name="Hero Section">
      <HeroContent />
      <HeroLogos />
    </div>
  );
...
function SectionHeader() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-1/2 overflow-clip px-[24px] py-[20px] top-0 translate-x-[-50%] w-[1016px]" data-name="section-header">
      <Header />
    </div>
  );
}
